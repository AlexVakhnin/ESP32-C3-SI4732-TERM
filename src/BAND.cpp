...
Band band[] = {
  {"VHF ", FM, 8400, 10800, 10710, 10}, //УКВ
  {"MW  ", AM, 520, 1720, 1385, 5}, //СВ
  {"All ", AM, 400, 29900, 400, 5},
  {"49m ", AM, 5600, 6300, 6000, 5},
  {"41m ", AM, 6800, 7800, 7295, 5}, // 40 meters
  {"31m ", AM, 9200, 10000, 9440, 5},
  {"25m ", AM, 11200, 12500, 12035, 5},
  {"22m ", AM, 13400, 13900, 13650, 5},
  {"19m ", AM, 15000, 15900, 15665, 5},
  {"18m ", AM, 17200, 17900, 17615, 5},
  {"CB  ", AM, 26200, 27900, 27190, 5} // CB band (11 meters)
};
...
Band band_ssb[] = {
  {"160m", LSB, 1800, 3500, 1900, 1},
  {"80m ", LSB, 3500, 4500, 3600, 1},
  //{"60m ", USB, 5250, 5450, 5250, 1},
  {"40m ", LSB, 7000, 7500, 7050, 1},
  {"30m ", USB, 10000, 11000, 10455, 1},
  {"20m ", USB, 14000, 14500, 14152, 1},
  {"17m ", USB, 18000, 18300, 18068, 1},
  {"15m ", USB, 20000, 21900, 20960, 1},
  {"12m ", USB, 24890, 26200, 24890, 1},
  {"CB  ", USB, 26200, 27900, 27190, 5}, // CB band (11 meters)
  {"10m ", USB, 28000, 30000, 28000, 1}
};
